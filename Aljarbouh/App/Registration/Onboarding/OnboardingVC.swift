...
class OnboardingVC: UIPageViewController {
    ...
    func setup() {
        ...
        let page1 = (self.storyboard?.instantiateViewController(withIdentifier: "OnboardingVC1"))!
        let page2 = (self.storyboard?.instantiateViewController(withIdentifier: "OnboardingVC2"))!
        let page3 = (self.storyboard?.instantiateViewController(withIdentifier: "OnboardingVC3"))!
...
//            view.topAnchor.constraint(equalTo: pageControl.topAnchor, constant: -545)
        ])
    }
